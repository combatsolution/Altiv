...
export default function QuickStartGuide({ data, isProUser }) {
  const checklistData =
    data?.data?.json_schema_data?.first_30_days_quick_start_checklist?.checklist || [];
  const timePeriod =
    data?.data?.json_schema_data?.first_30_days_quick_start_checklist?.time_period_definition?.T ||
      ...
      {!isProUser && (
        ...
        >
          ...
          <Typography variant="body2" sx={{ mb: 2, color: "text.secondary" }}>
            Upgrade to access full Quick Start Guide Section
          </Typography>
...
QuickStartGuide.propTypes = {
  ...
  isProUser: PropTypes.bool, // 🔹 Added for lock overlay control
};
