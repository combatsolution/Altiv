...
export default function TopTasksExposureAnalysis({ data, isProUser }) {
  // ✅ Dynamically access top_tasks_exposure_analysis from API response
  const top_tasks_exposure_analysis =
    data?.data?.json_schema_data?.top_tasks_exposure_analysis || [];

  return (
    <Box sx={{ position: "relative", p: 3, mx: "auto", maxWidth: { xs: "100%", md: "1200px" } }}>
      {/* Header */}
      <Box
        display="flex"
        justifyContent="space-between"
      ...
      {!isProUser && (
        ...
        >
          ...
          <Typography variant="h6" fontWeight={600}>
            Task Automation Locked
          </Typography>
          <Typography variant="body2" sx={{ mb: 2, color: "text.secondary" }}>
            Upgrade to access full taskautomation Section
          </Typography>
...
TopTasksExposureAnalysis.propTypes = {
  ...
  isProUser: PropTypes.bool, // 🔹 Added prop to toggle lock overlay
};
