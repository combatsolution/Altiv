          ...
          <Grid item xs="auto">
            <Box sx={{ maxWidth: 200 }}>
              <Stepper
                ...
                connector={<Box sx={{ height: isMdUp ? 100 : 40 }} />}
              >
                    ...
                    <StepLabel
                      sx={{
                        '& .MuiStepLabel-label': {
                          ...
                          color: index === 0 ? 'common.white' : 'grey.700', // Explicitly white for blue background
                          bgcolor: index === 0 ? 'primary.main' : 'common.white',
                          border: index === 0 ? 'none' : 1,
                          borderColor: index === 0 ? 'none' : 'grey.300',
                          borderRadius: '30%',
                          width: 64,
                          height: 64,
                          display: 'flex',
